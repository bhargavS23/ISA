...
<body>
    ...
    <div class="buttons">
        <a href="/InterviewSechdulerApplication/interview?action=showall" style="color: white;background-color: rgb(129, 182, 49);">Show All <i class="fa-solid fa-list-ol"></i></a>
    ...
    <div class="tabdata">
        <table>
            ...
            <tr>
                ...
                <td><a href="/InterviewSechdulerApplication/interview?action=edit&id=${interview.getScheduleId() }"><i style=color:blue class="fa-solid fa-pen-to-square"></i></a></td>
                <td><a href="/InterviewSechdulerApplication/interview?action=delete&id=${interview.getScheduleId() }"><i  class="fa-solid fa-trash" onclick="return confirm('Do you want to delete this applicant ?')"></i></a></td>
