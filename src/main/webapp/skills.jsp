...
<body>
    <h1>Skills</h1>
    <div class="buttons">
        <a href="/InterviewSechdulerApplication/skill?action=showall" style="color: white;background-color: rgb(129, 182, 49);">Show All <i class="fa-solid fa-list-ol"></i></a>
       <form action="/InterviewSechdulerApplication/skill?action=add" method="post">
    ...
    <div class="tabdata">
        <table>
            ...
            <tr>
                ...
                <td><a href="/InterviewSechdulerApplication/skill?action=delete&id=${skill.getSkillId() }"><i class="fa-solid fa-trash" onclick="return confirm('Do you want to delete this skill?')"></i></a></td>
            </tr>
            </c:forEach>
