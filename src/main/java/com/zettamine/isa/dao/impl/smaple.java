...
//		siDao.save(new ScheduleInterview(0, 3, 2, 2, "Krishna", "Rekha", "Santosh", Date.valueOf(LocalDate.of(2024, 1, 4)), Time.valueOf(LocalTime.of(11, 30)),Status.SCHEDULED));
...
//		siDao.save(new ScheduleInterview(0, 15, 5, 3, Date.valueOf(LocalDate.of(2024, 1, 16)), Time.valueOf(LocalTime.of(10, 00)),Status.SCHEDULED));
